...
if __name__ == "__main__":
    ...
    event = Events(id=2, titulo="Evento N", descripcion="Descripcion del Evento 1 Mod", ubicacion="Ubicacion del Evento 1", fecha_inicio="2021-10-10", fecha_final="2021-10-10", estado=1)
    ...
    print(taskController.getTaskById(4))
    print(eventController.getEventById(2))
